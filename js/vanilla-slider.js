...
function VanillaSlider(containerId) {
  ...
  this.container.style.height = imageElement.style.height;
  ...
  this.setSlideText = function (index) {
    ...
    if (_this.images[index].textTitle || _this.images[index].textBody) {
      ...
      switch (_this.images[index].textPosition) {
        case 'NW':
          _this.textOverlay.style.top = '10px';
          _this.textOverlay.style.left = '10px';
          break;

        case 'NE':
          _this.textOverlay.style.top = '10px';
          _this.textOverlay.style.right = '10px';
          break;

        case 'SE':
          _this.textOverlay.style.bottom = '10px';
          _this.textOverlay.style.right = '10px';
          break;
